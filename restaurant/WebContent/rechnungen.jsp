...
<ul class="nav nav-tabs">
    ...
    <li><a href="loeschen.jsp">Bestellungen l�schen</a></li>
</ul>

<h3>Rechnung</h3>
<br>
Neue Rechnung anlegen f�r:
<br>
    ...
    if( request.getParameterNames().hasMoreElements() == true
	    ...
	    try {
	    	...
	    	// Verbindung aufbauen
		      ...
		      int n = rsmd.getColumnCount(); // L�nge der Spalte
			  ...
			  out.println("<h4>Neue Rechnung f�r Tisch " + tischid + "</h4>");
		     ...
		     //F�r Jede Bestellid -> gib mir Name und Preis der Speise 
			 for(int i=0; i< bestellungen.size(); i++){
			     ...
			     int n1 = rsmd1.getColumnCount(); // L�nge der Spalte
			...
			//F�r jede Bestellung -> Gibt mir den Preis um den Rechnungsbetrag zu berechnen.	 
			 double preis= 0;
			 for(int i=0; i< bestellungen.size(); i++){
				 int bestellid = bestellungen.get(i);
			     ...
			     int n2 = rsmd2.getColumnCount(); // L�nge der Spalte
